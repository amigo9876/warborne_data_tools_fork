...
object DrifterResources {
    ...
    fun getDrifterFullBodyBg(drifter: String?): DrawableResource {
        return when (drifter) {
    ...
    fun getDrifterFullBody(drifter: String?): DrawableResource {
        return when (drifter) {
    ...
    fun getDrifterCard(drifter: String?): DrawableResource {
        return when (drifter) {
